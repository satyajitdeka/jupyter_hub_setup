...
helm repo update
# Run the config.yaml file to start up JupyterHub: RELEASE=NAMESPACE=myJupyterHub, JUPYTER_VERSION=0.9.0
helm upgrade --install myJupyterHub jupyterhub/jupyterhub --namespace myJupyterHub --version jupyterhub-0.9.0 --values config.yaml
